...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <div class="btn-group" role="group" aria-label="Grade Level Switch">
            <a
                href="{{ route('dashboard.index', ['grade_level' => '11']) }}"
                class="btn {{ ($selectedGradeParam ?? '11') === '11' ? 'btn-primary active' : 'btn-outline-primary' }}"
            >
                Grade 11
            </a>
            <a
                href="{{ route('dashboard.index', ['grade_level' => '12']) }}"
                class="btn {{ ($selectedGradeParam ?? '11') === '12' ? 'btn-primary active' : 'btn-outline-primary' }}"
            >
                Grade 12
            </a>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">{{ $totalSections ?? 0 }}</h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">{{ $totalTeachers ?? 0 }}</h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">{{ $totalSubjects ?? 0 }}</h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">{{ $totalRooms ?? 0 }}</h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1">{{ $totalSchedules ?? 0 }}</h2>
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card summary-card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    ...
                    <h2 class="fw-bold mb-1 text-danger">{{ $incompleteSchedules ?? 0 }}</h2>
            ...
            <div class="card content-card h-100">
                <div class="card-body p-4">
                    ...
                    <div class="border rounded-4 p-3 mb-3 bg-light">
                        ...
                        <div class="fw-semibold fs-5">{{ $activeSchoolYear?->name ?? 'Not Set' }}</div>
                    </div>

                    <div class="border rounded-4 p-3 mb-3 bg-light">
                        <div class="text-muted small">Term</div>
                        <div class="fw-semibold fs-5">{{ $activeSchoolTerm?->name ?? 'Not Set' }}</div>
                    </div>

                    <div class="border rounded-4 p-3 bg-light">
                        <div class="text-muted small">Selected Grade Level</div>
                        <div class="fw-semibold fs-5">{{ $selectedGradeLabel ?? 'Grade 11' }}</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            <a href="{{ route('academic-setup.index') }}" class="text-decoration-none">
                        ...
                        <div class="col-12 col-md-6">
                            <a href="{{ route('scheduling.index') }}" class="text-decoration-none">
                                <div class="border rounded-4 p-3 h-100 bg-white">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-4">
                            <div class="border rounded-4 p-3 bg-light h-100">
                                ...
                                <div class="fw-semibold">
                                    {{ ($configuredPathwayCount ?? 0) > 0 ? ($configuredPathwayCount . ' configured pathway/s in selected grade') : 'No pathways yet for selected grade' }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="border rounded-4 p-3 bg-light h-100">
                                ...
                                <div class="fw-semibold">
                                    {{ ($configuredShiftCount ?? 0) > 0 ? ($configuredShiftCount . ' shift type/s used by sections') : 'No shift setup yet for selected grade' }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="border rounded-4 p-3 bg-light h-100">
                                ...
                                <div class="fw-semibold">
                                    Dynamic dashboard view for {{ $selectedGradeLabel ?? 'Grade 11' }}
                                </div>
                            </div>
                        </div>
                    </div>
